...
const CLASSES = [
  ...
  {
    id: 'mmetal', code: 'MWT302', fullName: 'Metallic Materials', ects: 6,
    enrolled: 134, userRank: 67, userScore: 71, hasCatchup: false, catchupTopics: [],
    checkpoints: [
      { date: 'Jan 16', status: 'done',     score: 74 },
      { date: 'Jan 23', status: 'done',     score: 69 },
      { date: 'Jan 30', status: 'weak',     score: 62 },
      { date: 'Feb 6',  status: 'upcoming', score: null },
      { date: 'Feb 13', status: 'upcoming', score: null },
    ],
  },
];
  ...
  mmetal: [
    {
      ...
      question: 'Which crystal structure does pure aluminium adopt at room temperature?',
      options: ['Body-centred cubic (BCC)', 'Face-centred cubic (FCC)', 'Hexagonal close-packed (HCP)', 'Simple cubic (SC)'],
      answer: 1,
      explanation: 'Aluminium is an FCC metal with a packing factor of 0.74, giving it high ductility. Most common non-ferrous structural metals (Cu, Al, Ni, Au) are FCC.',
    },
    {
      id: 'mmetal-2',
      topic: 'Crystal Structures',
      question: 'In an HCP crystal, the ideal c/a ratio is approximately:',
      options: ['1.414', '1.633', '1.732', '2.000'],
      answer: 1,
      explanation: 'The ideal c/a ratio for HCP is √(8/3) ≈ 1.633, derived from the condition that all nearest-neighbour distances are equal. Metals like Zn deviate from this.',
    },
    {
      id: 'mmetal-3',
      topic: 'Phase Diagrams',
      question: 'In the iron-carbon phase diagram, the eutectoid composition is approximately:',
      options: ['0.02 wt% C', '0.77 wt% C', '2.14 wt% C', '4.30 wt% C'],
      answer: 1,
      explanation: 'At 0.77 wt% C and 723°C, austenite transforms to pearlite (ferrite + cementite) in the eutectoid reaction. Steels with this composition are called eutectoid steels.',
    },
    {
      id: 'mmetal-4',
      topic: 'Phase Diagrams',
      question: 'A hypereutectoid steel (e.g. 1.2 wt% C) cooled slowly from the austenite region will first form:',
      options: ['Proeutectoid ferrite at grain boundaries', 'Proeutectoid cementite at grain boundaries', 'Martensite throughout the matrix', 'Bainite along grain boundaries'],
      answer: 1,
      explanation: 'For compositions above the eutectoid (>0.77 wt% C), cementite (Fe₃C) precipitates at austenite grain boundaries before the remaining austenite transforms to pearlite at 723°C.',
    },
    {
      id: 'mmetal-5',
      topic: 'Steel / Iron Metallurgy',
      question: 'The maximum solubility of carbon in austenite (γ-Fe) is approximately:',
      options: ['0.02 wt% at 727°C', '0.77 wt% at 727°C', '2.14 wt% at 1148°C', '6.70 wt% at 1148°C'],
      answer: 2,
      explanation: 'Carbon is much more soluble in the FCC austenite structure than in BCC ferrite. The maximum solubility of 2.14 wt% occurs at 1148°C. Above this limit, cast irons are formed.',
    },
    {
      id: 'mmetal-6',
      topic: 'Heat Treatment',
      question: 'Tempering of martensite is performed to:',
      options: ['Increase hardness by forming more martensite', 'Relieve brittleness by allowing limited carbon diffusion and carbide precipitation', 'Re-austenitise the steel for a second quench', 'Increase surface carbon content via carburisation'],
      answer: 1,
      explanation: 'As-quenched martensite is hard but brittle. Tempering (typically 150–700°C) allows carbon atoms to diffuse slightly and fine carbides to precipitate, reducing hardness while greatly improving toughness.',
    },
    {
      id: 'mmetal-7',
      topic: 'Heat Treatment',
      question: 'Case hardening by carburisation increases the carbon content of the steel surface so that subsequent quenching produces:',
      options: ['A hard martensitic case with a tough low-carbon core', 'A soft ferritic case with a hard bainitic core', 'Full martensite throughout the entire component', 'A pearlitic case with a martensitic core'],
      answer: 0,
      explanation: 'Carburising adds carbon to the surface layer (to ~0.8–1.0 wt% C). On quenching, only the high-carbon surface forms martensite while the low-carbon core remains tough ferrite/pearlite.',
    },
    {
      id: 'mmetal-8',
      topic: 'Mechanical Properties',
      question: 'The ultimate tensile strength (UTS) of a steel is reached at the point on the stress-strain curve where:',
      options: ['Fracture occurs', 'Necking begins and the engineering stress reaches its maximum', 'The elastic limit is first exceeded', 'Strain hardening rate becomes zero and the material is fully work-hardened'],
      answer: 1,
      explanation: 'UTS corresponds to the onset of necking. Beyond UTS, deformation localises in the neck and the engineering stress decreases even though the true stress continues to rise until fracture.',
    },
    {
      id: 'mmetal-9',
      topic: 'Mechanical Properties',
      question: 'Work hardening (strain hardening) of a metal increases yield strength because:',
      options: ['The grain size decreases significantly during deformation', 'The dislocation density increases, making further dislocation motion more difficult', 'Carbon atoms migrate to grain boundaries during deformation', 'Recovery and recrystallisation occur simultaneously during cold work'],
      answer: 1,
      explanation: 'Plastic deformation multiplies dislocations. The resulting dislocation tangles impede further dislocation glide, requiring higher stress for continued deformation — hence increased yield strength.',
    },
    {
      id: 'mmetal-10',
      topic: 'Alloys',
      question: 'Austenitic stainless steels (e.g. 304) retain an FCC structure at room temperature primarily because of:',
      options: ['High carbon content stabilising austenite', 'Nickel additions that expand the austenite phase field and lower the Ms temperature below room temperature', 'Molybdenum raising the Curie temperature', 'Chromium promoting the BCC ferrite structure'],
      answer: 1,
      explanation: 'Nickel is a strong austenite stabiliser. Together with chromium (for corrosion resistance), Ni in 18/8 (18 Cr, 8 Ni) stainless keeps the structure FCC down to very low temperatures.',
    },
    {
      id: 'mmetal-11',
      topic: 'Alloys',
      question: 'The main purpose of adding molybdenum to stainless steel is to:',
      options: ['Raise the melting point for high-temperature service', 'Enhance pitting corrosion resistance, especially in chloride environments', 'Promote ferrite formation over austenite', 'Increase the carbon content of the alloy'],
      answer: 1,
      explanation: 'Mo forms stable passive oxide films and prevents chloride-induced breakdown. Grade 316 (2–3% Mo) is used in marine and chemical environments for this reason.',
    },
    {
      id: 'mmetal-12',
      topic: 'Corrosion',
      question: 'Passivation of stainless steel refers to:',
      options: ['Cathodic protection by an applied current', 'Formation of a thin, adherent Cr₂O₃ surface oxide layer that acts as a barrier to further oxidation', 'Galvanising the steel surface with zinc', 'Heat treatment to remove residual stresses that promote stress-corrosion cracking'],
      answer: 1,
      explanation: 'Chromium (≥10.5 wt%) reacts with oxygen to form a self-healing Cr₂O₃ passive film ~2–3 nm thick. This film prevents further corrosion and reforms spontaneously if mechanically damaged.',
    },
    {
      id: 'mmetal-13',
      topic: 'Corrosion',
      question: 'Galvanic corrosion between two dissimilar metals is most severe when:',
      options: ['The metals are close together in the galvanic series', 'The area of the less noble (anodic) metal is small compared to the more noble (cathodic) metal', 'The electrolyte is deionised water with very low conductivity', 'Both metals have identical electrode potentials'],
      answer: 1,
      explanation: 'A small anode / large cathode area ratio concentrates the anodic corrosion current on a small area, greatly accelerating the corrosion rate of the less noble metal.',
    },
    {
      id: 'mmetal-14',
      topic: 'Crystal Structures',
      question: 'The atomic packing factor (APF) for an FCC crystal is:',
      options: ['0.52', '0.68', '0.74', '0.91'],
      answer: 2,
      explanation: 'FCC has 4 atoms per unit cell and the hard-sphere radius is a√2/4. APF = (4 × 4/3 π r³) / a³ = π/(3√2) ≈ 0.7405. BCC APF is 0.68; SC is 0.52.',
    },
    {
      id: 'mmetal-15',
      topic: 'Mechanical Properties',
      question: 'The ductile-to-brittle transition temperature (DBTT) is a concern primarily in:',
      options: ['FCC metals such as copper and aluminium', 'BCC metals and alloys such as low-carbon steels at sub-zero temperatures', 'Austenitic stainless steels used at cryogenic temperatures', 'All metallic materials regardless of crystal structure'],
      answer: 1,
      explanation: 'BCC metals lack sufficient active slip systems at low temperatures, causing a transition from ductile to brittle fracture. FCC metals (Al, Cu, austenitic SS) do not exhibit a sharp DBTT.',
    },
  ],
};
