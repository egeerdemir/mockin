  ...
  mmetal: [
    {
      ...
      text: 'Which crystal structure does pure aluminium adopt at room temperature?',
    ...
    },
    {
      id: 'mmetal-2',
      topic: 'Crystal Structures',
      text: 'In an HCP crystal, the ideal c/a ratio is approximately:',
    ...
    },
    {
      ...
      text: 'In the iron-carbon phase diagram, the eutectoid composition is approximately:',
    ...
    },
    {
      id: 'mmetal-4',
      topic: 'Phase Diagrams',
      text: 'A hypereutectoid steel (e.g. 1.2 wt% C) cooled slowly from the austenite region will first form:',
    ...
    },
    {
      ...
      text: 'The maximum solubility of carbon in austenite (γ-Fe) is approximately:',
    ...
    },
    {
      ...
      text: 'Tempering of martensite is performed to:',
    ...
    },
    {
      id: 'mmetal-7',
      topic: 'Heat Treatment',
      text: 'Case hardening by carburisation increases the carbon content of the steel surface so that subsequent quenching produces:',
    ...
    },
    {
      ...
      text: 'The ultimate tensile strength (UTS) of a steel is reached at the point on the stress-strain curve where:',
    ...
    },
    {
      id: 'mmetal-9',
      topic: 'Mechanical Properties',
      text: 'Work hardening (strain hardening) of a metal increases yield strength because:',
    ...
    },
    {
      id: 'mmetal-10',
      topic: 'Alloys',
      text: 'Austenitic stainless steels (e.g. 304) retain an FCC structure at room temperature primarily because of:',
    ...
    },
    {
      id: 'mmetal-11',
      topic: 'Alloys',
      text: 'The main purpose of adding molybdenum to stainless steel is to:',
    ...
    },
    {
      id: 'mmetal-12',
      topic: 'Corrosion',
      text: 'Passivation of stainless steel refers to:',
    ...
    },
    {
      id: 'mmetal-13',
      topic: 'Corrosion',
      text: 'Galvanic corrosion between two dissimilar metals is most severe when:',
    ...
    },
    {
      id: 'mmetal-14',
      topic: 'Crystal Structures',
      text: 'The atomic packing factor (APF) for an FCC crystal is:',
    ...
    },
    {
      id: 'mmetal-15',
      topic: 'Mechanical Properties',
      text: 'The ductile-to-brittle transition temperature (DBTT) is a concern primarily in:',
